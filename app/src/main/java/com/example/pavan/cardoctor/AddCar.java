...
public class AddCar extends AppCompatActivity {
    ...
    ListView listview;
    String emailId;
    ArrayList<AddCarList> results;
    AddCarCustomListAdapter  addCLA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AddCar.this);
                ...
                alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        AddCarList item = (AddCarList) (listview.getItemAtPosition(pos));

                       // Toast.makeText(AddCar.this,item.getId().toString(),Toast.LENGTH_LONG).show();

                        new AddCarListDelete().execute(emailId,item.getId().toString());
    ...
    public void addCar(View view){
        Intent i = new Intent(this,AddCarSubmit.class);
        startActivity(i);
        finish();
    }
    ...
    private class AddCarListDelete extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(AddCar.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://192.168.10.107/cardoctor/deletecar.php");
    ...
    private class AddCarListShow extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                // Enter URL address where your php file resides
                url = new URL("http://192.168.10.107/cardoctor/showcarlist.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < arr.length(); i++) {
                    ...
                    list.setName(post.getString("name"));
                    list.setBrand(post.getString("brand"));
                    list.setMadeyear(post.getString("madeyear"));
                 ...
                 addCLA = new AddCarCustomListAdapter(AddCar.this, results);
